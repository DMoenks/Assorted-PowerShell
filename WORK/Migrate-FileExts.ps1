...
# Intention: Delete custom user actions for specified file types on target computers and copy HKCR information
# for both the file types and matching MIME types from a source computer.
